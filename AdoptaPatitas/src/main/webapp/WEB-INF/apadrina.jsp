...
<body>
	<nav class="navbar navbar-expand-lg" style="background-color: #D9F0DE";>
		...
		<div class="row">
			<div class ="col">
				<a href="https://fundacionhuellaanimal.cl/apadrina-un-animal-rescatado/"><img src="/img/Roy.png" alt="Roy" class="img-fluid"></a><p>Roy</p>
				
			</div>
			<div class ="col">
				<a href="https://fundacionhuellaanimal.cl/apadrina-un-animal-rescatado/"><img src="/img/Kafka.jpg" alt="Kafka" class="img-fluid" width="400" height="400"></a><p>Kafka</p>
			</div>
			<div class ="col">
				<img src="https://pumakawa.org/wp-content/uploads/2020/02/Sacha.jpg" alt="Maico y Sacha" class="img-fluid"><p>Maico y Sasha</p>
			</div>
		</div>
		<div class="row">
			<div class ="col">
			...
			<div class ="col">
				<img src="https://pumakawa.org/wp-content/uploads/2019/12/Estanislao-Monte.jpg" alt="Estanislao" class="img-fluid"><p>Estanislao</p>
			</div>
			<div class ="col">
				<img src="https://pumakawa.org/wp-content/uploads/2020/02/Firpa-y-Unhito.jpg" alt="Firpa y Unhito" class="img-fluid"><p>Firpa y Unhito</p>
			</div>
		</div>
		<div class="row">
			<div class ="col">
				<img src="https://pumakawa.org/wp-content/uploads/2020/02/Linda.jpg" alt="Linda" class="img-fluid"><p>Linda</p>
			</div>
			<div class ="col">
